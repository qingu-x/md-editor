...
pnpm build:server   # 服务端
pnpm build:electron # 桌面应用 (macOS)
```
...
本项目已进行全面的性能优化,详见 [OPTIMIZATION.md](OPTIMIZATION.md)

### 主要优化

- 🚀 **构建优化**: Turbo 缓存 + Vite 智能分包
- 📦 **包体积优化**: 代码分割 + Tree Shaking + 压缩
- 🔧 **TypeScript 优化**: 增量编译 + 严格类型检查
